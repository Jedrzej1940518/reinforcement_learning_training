...
def train():
    ...
    dqn = SimpleDQN(max_a_breakout, "DQN/Breakout/Terminal_Life_Lost" , 100_000, batch_size=32, gamma= 0.99, lr=0.00001, update_target_estimator_frequency=10_000, resume=False, export_model = True)
